...
namespace DevOpsPortal.Web.Migrations
{
    ...
    [Migration("20191215175936_Added Relationships")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("DevOpsPortal.Data.ApplicationUser", b =>
                {
                    ...
                    b.HasData(
                        new { Id = "202", AccessFailedCount = 0, ConcurrencyStamp = "4ec297e6-30fc-4f6a-ba5c-a56af51be5b3", Email = "Plainvanilla@test.com", EmailConfirmed = true, FirstName = "PlainVanillaFirstName", IsPasswordReset = false, LastName = "PlainVanillaLastName", LockoutEnabled = false, OrgId = 1, OrgLevelTypeId = 1, OrgLevelid = 1, PhoneNumberConfirmed = false, TwoFactorEnabled = false, UserName = "PlainVanillaUser", User_Active = true }
                    );
                });
            ...
            modelBuilder.Entity("DevOpsPortal.Data.ApplicationRole", b =>
                {
                    ...
                    b.HasData(
                        new { Id = "101", ConcurrencyStamp = "9912eb91-6497-42dd-b9ba-83fa0f906cd6", Name = "Developer", Description = "TestRole" }
                    );
                });

            modelBuilder.Entity("DevOpsPortal.Data.ApplicationUserRole", b =>
                {
            ...
            modelBuilder.Entity("DevOpsPortal.Data.ApplicationUserRole", b =>
                {
                    b.HasOne("DevOpsPortal.Data.ApplicationRole")
                        .WithMany("UserRoles")
